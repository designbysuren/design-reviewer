...
Run in CODE mode, against the source file. The same fixture reviewed in SCREEN mode, from a
screenshot alone, produces a different and less certain report: see
[the naive comparison](experiment-naive-vs-evidence.md).
...
Six of the 40 CODE-mode checks could not be run from this file alone:
